      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="book.php">Book a Flight <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    width: 50%;">
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" name="f_id" class="form-control"  placeholder="Flight ID">
        </div>
        <div class="form-group col-md-6">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" name="f_class" class="form-control" placeholder="Business/Economy">
        </div>
        <div class="form-group col-md-6">
          <label for="inputEmail4">Seat No.</label>
          <input type="text" name="f_seat" class="form-control" placeholder="Number">
        </div>
      </div>
